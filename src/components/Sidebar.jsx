...
function ExampleCard({ example, onLoadExample, showCategory = false, isActive = false, cardRef }) {
  return (
    <button
      ...
      className={`w-full text-left px-4 py-3 border-b border-l-2 transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-indigo-500 ${
        isActive
...
export default function Sidebar({ onLoadExample, pattern, flags, isOpen, onClose }) {
    ...
    <>
      ...
      <aside
        className={`
          ...
          md:static md:top-auto md:bottom-auto md:z-auto md:w-64 md:flex-shrink-0
      ...
      >
        <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-800 flex-shrink-0 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="md:hidden p-1 rounded-md text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
        ...
        <div className="px-3 py-2 border-b border-gray-200 dark:border-gray-800 flex-shrink-0">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-7 pr-6 py-1.5 rounded-md bg-gray-100 dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-600 outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
            />
            {query && (
              <button
                onClick={() => setQuery('')}
                className="absolute right-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 leading-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
